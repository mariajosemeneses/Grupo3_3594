    ...
    <div style="text-align:center " class="ctn-b ">
        ...
        <div style="width:100%; height:100%, text-align: center ">
            <p>
                ...
                <br>
                <a href="../../modificar.php"><svg xmlns="http://www.w3.org/2000/svg " class="icon icon-tabler icon-tabler-circle-plus " width="80 " height="80 " viewBox="0 0 24 24 " stroke-width="1.5 " stroke="#ffffff " fill="none " stroke-linecap="round
        " stroke-linejoin="round ">
                <path stroke="none " d="M0 0h24v24H0z " fill="none "/>
