...
?>
    ...
    <h1><font color="white"><?php if(isset($getProductData) && is_array($getProductData)){?></font></h1>
            ...
            <div class="col-md-7">
                ...
                <form class="form-inline" method="POST">
                    ...
                    <div class="form-group mb-2 ml-2">
                        <button type="submit" class="btn btn-primary" name="add_to_cart" value="add to cart">Añadir a Carrito</button>
                    </div>
                </form>
