  ...
  if($_SERVER['REQUEST_METHOD'] === 'POST'){
     ...
     //echo "</pre>";
      ...
      if(empty($errores)) 
      {
            ...
            $query = "UPDATE propiedades SET plato = '${plato}', precio = ${precio}, categoria = '${categoria}', descripcion = '${descripcion}', imagen = '${nombreImagen}' WHERE id = ${id}";
...
<body body topmargin="0 ">
    <div class="ctn">
        <p>
            ...
            <a href="Modificar.html" style="float:right ; margin-right: 20px ">
    ...
    <main>
        <form class="formulario" style="position:relative; top:3rem;" method="POST" action="#" enctype="multipart/form-data">

        <div class="contenedor-campos">
                <div class="campo">
                    <label>Nombre  Plato:</label>

                    <input class="input-text" type="text"  name= "nombrePlato" required>
                </div>
                <div class="campo">
                    <label>Precio</label>
                ...
                <div class="img-act">
                    ...
                    <img src="../../img/<?php echo $imagen; ?>" class="imagen">
                </div>
            </div>
